...
<body>
    ...
    <div class="container-fluid">
        <div class="card col-4 offset-4">
            ...
            <?php if (isset($_SESSION['registerErrorMsg'])) {echo '<p style="color:red; padding-top:20px; text-align:center;">'.$_SESSION['registerErrorMsg'].'</p>'; unset($_SESSION['registerErrorMsg']);}; ?>
